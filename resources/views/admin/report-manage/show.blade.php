        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card card-default">
                    <div class="alert card-header alert-success">Information report</div>
                    <div class="card-body">
                        @if (session('status'))
                        ...
                        <a href="{{ route('admin.report.index') }}"><button type="button" class="btn btn-success" ><i></i>Back</button></a>
                    </div>
                </div>
            </div>
        </div>

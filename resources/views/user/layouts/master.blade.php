        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('report.create') }}"><i class="fa fa-circle-o"></i>Create Report</a></li>
                        <li><a href="{{ route('report.index') }}"><i class="fa fa-circle-o"></i>Your Report</a></li>
                    </ul>
                </li>
                <li class="treeview">
                    <a href="#">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li><a href=""><i class="fa fa-circle-o"></i>All cateogries</a></li>
